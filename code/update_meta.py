...
# h5ad_path = '/mnt/f/H3K27/Data/scATAC/scATAC_fixed.h5ad'
# output_path = '/mnt/f/H3K27/Data/scATAC/scATAC_peak_save.h5ad'
# h5ad_path = '/mnt/f/H3K27/Data/scChi/scChi_accessibility_fixed2.h5ad'
# output_path = '/mnt/f/H3K27/Data/scChi/scChi_save.h5ad'

# --- Define Join Parameters ---
join_string='Sample_ID' # The column to use for joining (e.g., 'Sample_ID' or 'Condition')
all_colums = ['Batch_ID', join_string, 'Cancer_Type', 'Cancer_Status', 'Response_Status', 'Condition', ]
