...
# --- CONFIGURATION ---
DEFAULT_FOLDER = '/mnt/f/H3K27/Data/CCC_EC/'
DEFAULT_N = 5
...
def combined_gsea_lollipop(
    ...
    CELLTYPE_COLOR_MAP = {
        ...
        # New Entries
        'OC': '#a55194',  # A deep purple/magenta, distinct from Adipocytes/Mesothelial
        'EC': '#1f77b4',  # A light orange/peach, distinct from Normal_Epithelial
    }
